...
class MiniCPMV(MiniCPMVPreTrainedModel):
    ...
    def chat(
        ...
        max_slice_nums=None,
        use_image_id=None,
        output_type='assistant', #edited here
        **kwargs
    ):
        ...
        for image, msgs in zip(images_list, msgs_list):
            ...
            custom_generation_prompt = processor.tokenizer.apply_chat_template(copy_msgs, tokenize=False, add_generation_prompt=False)
            

            if output_type == 'plan':
                custom_generation_prompt += "<|im_start|>plan\n"
            else:
                custom_generation_prompt += "<|im_start|>assistant\n"

            prompts_lists.append(custom_generation_prompt)
